...
{
    public partial class AddCloseBonusPeriodFunction : Migration
    {
...
$$;
        ...
        {
            migrationBuilder.Sql(@"DROP FUNCTION IF EXISTS close_bonus_period(text, integer, timestamp with time zone, text);");
        }
    }
}
