...
namespace V1.Infrastructure.Migrations
{
    ...
    [Migration("20220821182111_UpdateCloseBonusPeriodFunctionToSaveRates")]
    partial class UpdateCloseBonusPeriodFunctionToSaveRates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BonusCalcApi.V1.Infrastructure.BonusRate", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_bonus_rates");

                    b.ToTable("bonus_rates", (string)null);
                });
            ...
            modelBuilder.Entity("BonusCalcApi.V1.Infrastructure.Trade", b =>
                {
                    ...
                    b.HasIndex("RateCode")
                        .HasDatabaseName("ix_trades_rate_code");
            ...
            modelBuilder.Entity("BonusCalcApi.V1.Infrastructure.Trade", b =>
                {
                    b.HasOne("BonusCalcApi.V1.Infrastructure.BonusRate", "BonusRate")
                        .WithMany()
                        .HasForeignKey("RateCode")
                        .HasConstraintName("fk_trades_bonus_rates_bonus_rate_id");
